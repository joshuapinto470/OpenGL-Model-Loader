...
Mesh Model::processMesh(aiMesh *mesh, const aiScene *scene)
{
    ...
    for (unsigned int i = 0; i < mesh->mNumVertices; i++)
    {
        ...
        vector.z = -1.0 * mesh->mVertices[i].y;
        ...
        if (mesh->HasNormals())
        {
            ...
            vector.z = -1.0 * mesh->mNormals[i].y;
...
// std::vector<Texture> Model::loadMaterialTextures(aiMaterial *mat, aiTextureType type, std::string path)
// {
//     std::vector<Texture> textures;
